...
Usage:
    python3 tools/test_assets.py <rom> [options]

Examples:
    python3 tools/test_assets.py roms/pal_gc_0227d7.z64 --category objects
    python3 tools/test_assets.py roms/pal_gc_0227d7.z64 --file gameplay_keep
    python3 tools/test_assets.py roms/pal_gc_0227d7.z64 --category objects --type GFX --failures-only
"""
...
def run_torch(scratch_dir, rom, work_dir):
    ...
    with open(log_path, "w") as log_f:
        result = subprocess.run(
            [TORCH, "o2r", "-s", scratch_dir, "-d", o2r_out, "-u", "9.2.3", rom],
