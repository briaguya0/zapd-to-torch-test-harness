...
Usage:
    python3 tools/list_assets.py --manifest o2r/manifest.json --summary
    python3 tools/list_assets.py --manifest o2r/manifest.json --category objects
    python3 tools/list_assets.py --manifest o2r/manifest.json --category objects --type GFX
    python3 tools/list_assets.py --manifest o2r/manifest.json --file gameplay_keep
"""
...
def main():
    ...
    # Auto-detect yaml_dir: manifest is at o2r/manifest.json, YAMLs at assets/yml/
